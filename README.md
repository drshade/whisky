...
| Glenlivet 15 French Oak Reserve `(s)` | 80* | very plain and smooth — nice but not much character, really inoffensive with nothing particularly interesting going on. Sampled on holiday in the heat: half neat, then over ice. Not a proper tasting | **Official (The Glenlivet) + Whiskybase (81.7 from 785 ratings):** Ex-bourbon American oak with a portion finished in new French Limousin oak (the cognac wood); 40%, chill-filtered and coloured. Whisky Advocate ~87, unconfirmed — two review entries exist for different generations |
