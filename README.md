...
| Bain's Cape Mountain `(s)` | 78 | very simple but not unpleasant; unexpectedly bourbony (ex-bourbon cask does all the talking); a touch more detail than single-note but ordinary overall — remarkable value at R280/~€14 | **Official (Bain's) + The Whiskey Wash:** 100% SA yellow maize, double-matured in first-fill ex-bourbon casks; approachable and well-balanced rather than complex |
